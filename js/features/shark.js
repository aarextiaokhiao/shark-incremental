const SHARK = {
    ...
    rank: {
        get require() { return Decimal.pow(1.2,player.shark_rank.add(1).scale(1250,3,'E2').scale(tmp.sr_scale,2,'P')).sub(1).mul(500).ceil() },
        get bulk() { return tmp.shark_elo.div(500).add(1).log(1.2).scale(tmp.sr_scale,2,'P',true).scale(1250,3,'E2',true).floor() },
